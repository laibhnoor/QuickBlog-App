...
const Header = () => {
  ...
  return (
    ...
    gap-4 px-6 py-1.5 mb-4 border border-primary/40
    bg-primary/10 rounded-full text-sm text-primary'>
       <p>New: AI feature integrated </p>
       <img src={assets.star_icon} 
       className='w-2.5' alt="" ></img>
    </div>
      
      <h1 className='text-3x1 sm:text-6xl font-semibold
     ...
     text-gray-500'>This is your space to think out loud to share what matters,
        and to write without filters.Whether ots one word or a thousand,
    ...
    <input ref={inputRef} type="text" placeholder="search for blogs" required
        className='w-full pl-4 outline-none'></input>
    <button className='bg-primary text-white px-8 py-2 m-1.5
