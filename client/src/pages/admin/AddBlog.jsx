...
const AddBlog = () => {
  ...
  const generateContent = async () => {
    ...
    try {
      ...
      console.log('Sending request with title:', title); // Debug log
      ...
      if (data.success) {
        // Use the content directly if it's already formatted, or parse if it's markdown
        const formattedContent = data.content.includes('**') || data.content.includes('#') 
          ? parse(data.content) 
          : data.content;
